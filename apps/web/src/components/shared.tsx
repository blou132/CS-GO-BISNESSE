...
const statusLabels: Record<MarketStatus["status"], string> = { online: "En ligne", degraded: "Collecte partielle", not_configured: "Non configuré", unavailable: "Indisponible", error: "En erreur", stale: "Données périmées", very_stale: "Très périmées", demo: "Démo", idle: "En attente" };
